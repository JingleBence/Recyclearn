...
public class BuyerTradeQr extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    String username, buyerName, location;
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(okButtonIsClicked == false)
                    ...
                    Toast.makeText(BuyerTradeQr.this,+newPointsBasedOnKGInput+" Points Sent to " +nameOfSeller+ ", Transaction Successful!",Toast.LENGTH_SHORT).show();
